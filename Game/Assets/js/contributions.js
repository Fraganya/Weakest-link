var SuggestBox=React.createClass({displayName: "SuggestBox",
    ...
    renderQuestionForm:function()
    {
        return(
            ...
            React.createElement("textarea", {className: "form-control", rows: "5", placeholder: "your question here"})
            ), 
    ...
    renderIdeaForm:function()
    {
        return(
            ...
            React.createElement("textarea", {className: "form-control", rows: "9", placeholder: "your suggestion here"})
            ), 
