...
registerGame:function()
{
    ...
    {
        $(this.refs.registrationStatus).addClass('well-danger');
        return false;
    }
...
getNames:function()
{
    return (
            ...
            React.createElement("div", {className: "well well-sm well-danger", ref: "registrationStatus"}, "Fill in the details"), 
