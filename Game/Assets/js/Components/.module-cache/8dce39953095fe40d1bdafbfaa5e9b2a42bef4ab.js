...
getNames:function()
{
    return (
            ...
            React.createElement("div", {className: "form-group marg-top"}, 
                React.createElement("button", {className: "btn wk-btn pull-right marg-1", type: "button"}, "Register"), 
                React.createElement("button", {className: "btn wk-btn pull-right marg-1", type: "button"}, "← Back")
            )
            )
    );
},
