...
{
    var fields='<form className="form-horizontal col-sm-12 col-xs-12>';
    for(var counter=0;counter<count;counter++)
    {
        fields+='<div className="section-label">Player '+(counter+1)+'</div';
        fields+='<div className="form-group col-sm-12" ref="player-'+counter+'">';
        fields+='<input type="text" className="form-control" placeholder="First-name" />';
        fields+='<input type="text" className="form-control" placeholder="Surname" />';
        fields+='<input type="text" className="form-control" placeholder="Location e.g Blantyre" />';
        fields+='</div>';
    }
    fields+='</form>';
