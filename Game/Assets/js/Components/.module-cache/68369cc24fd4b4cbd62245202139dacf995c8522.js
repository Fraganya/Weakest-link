...
getNames:function()
{
    return (
            ...
            React.createElement("div", {className: "form-group col-sm-12"}, 
              React.createElement("button", {className: "btn wk-btn marg-1", type: "button", onClick: this.registerGame}, "Register"), 
              React.createElement("button", {className: "btn wk-btn marg-1", type: "button", onClick: this.reset}, "←")
            )
            )
    );
},
