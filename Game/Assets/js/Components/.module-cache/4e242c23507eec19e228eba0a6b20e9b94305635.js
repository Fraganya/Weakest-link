var playerEntry=React.createClass({displayName: "playerEntry",
    render:function()
    {
         React.createElement("div", {class: "form-group "}, 
            React.createElement("label", {class: "section-label col-sm-12"}, "Player ", this.props.cnum), "';", 
            React.createElement("div", {class: "col-sm-4"}, "';", 
            React.createElement("input", {type: "text", class: "form-control", placeholder: "First-name"}), "';"
            ), 
            React.createElement("div", {class: "col-sm-4"}, "';", 
            React.createElement("input", {type: "text", class: "form-control", placeholder: "Surname"}), "';"
            ), 
            React.createElement("div", {class: "col-sm-4"}, "';", 
            React.createElement("input", {type: "text", class: "form-control", placeholder: "Location (e.g Blantyre)"}), "';"
            )
         )
    }
});
...
buildFields:function(count)
{
    ...
    */
    ...
    for(var counter=1;counter<=count;counter++)
    {
        newPlayer=React.createElement("playerEntry", {cnum: counter})
        arr.push(newPlayer);
    }
    return arr;
},
...
getNames:function()
{
    return (
            ...
            React.createElement("div", {className: "well well-sm", ref: "registrationStatus"}, "Fill in the details"), 
             this.buildFields(this.state.playerCount), 
