...
getNames:function()
{
    return (
            ...
            React.createElement("div", {className: "form-group"}, 
                React.createElement("button", {className: "btn wk-btn pull-left", type: "button"}, "Register"), 
                React.createElement("button", {className: "btn wk-btn pull-left", type: "button"}, "Back")
            )
            )
    );
},
