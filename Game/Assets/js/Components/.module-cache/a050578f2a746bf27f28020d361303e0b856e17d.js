...
getNames:function()
{
    return (
            ...
            React.createElement("div", {className: "form-group col-sm-12"}, 
              React.createElement("button", {className: "btn wk-btn ", type: "button", onClick: this.registerGame}, "Register"), 
              React.createElement("button", {className: "btn wk-btn ", type: "button", onClick: this.setState({step:'init'})}, "Register")
            )
            )
    );
},
