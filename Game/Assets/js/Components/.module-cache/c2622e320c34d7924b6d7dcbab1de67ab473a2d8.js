...
buildFields:function(count)
{
    ...
    {
        fields+='<label className="col-sm-12">Player '+counter+'</div';
        fields+='<div className="form-group col-sm-4" ref="player-'+counter+'-fname">';
        fields+='<input className="form-control" placeholder="First-name" />';
        fields+='</div>';
        fields+='<div className="form-group col-sm-4" ref="player-'+counter+'-sname">';
        fields+='<input className="form-control placeholder="Surname" />';
        fields+='</div>';
        fields+='<div className="form-group col-sm-4" ref="player-'+counter+'-location">';
        fields+='<input className="form-control" placeholder="Location e.g Blantyre" />';
        fields+='</div>';
    }
