...
buildFields:function(count)
{
    ...
    {
        fields+='<div class="section-label">Player '+(counter+1)+'</div';
        fields+='<div class="form-group col-sm-12" id="player-'+counter+'">';
        fields+='<input type="text" class="form-control col-sm-4" placeholder="First-name" />';
        fields+='<input type="text" class="form-control col-sm-4"" placeholder="Surname" />';
        fields+='<input type="text" class="form-control col-sm-4"" placeholder="Location e.g Blantyre" />';
        fields+='</div>';
    }
    fields+='</form>';
