    ...
    render:function()
    {
        var innerBody="";
         if(this.props.hasBody)
            {
                innerBody+="<div className='panel-body'>";
                innerBody+=this.props.info;
                innerBody+='</div>'
            }  
        return(
            React.createElement("div", {className: "panel panel-default"}, 
                ...
                React.createElement("div", {dangerouslySetInnerHTML: innerBody})
...
var modifications=React.createClass({displayName: "modifications",
    render:function()
    {
        return(
            halla
